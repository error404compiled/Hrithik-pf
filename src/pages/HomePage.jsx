...
export default function HomePage() {
  ...
  return (
    <>
      <Helmet>
        <title>HritikSharma.me | AI/ML Engineer</title>
        <meta
          name="description"
          content="Hritik Sharma's portfolio — Building AI/ML systems, NLP, computer vision. Software Engineer at MAQ Software."
        />
      </Helmet>
        ...
        <section className="flex flex-col items-start gap-8 md:flex-row-reverse md:items-center md:justify-between">
          ...
          <div className="flex max-w-[320px] flex-col sm:max-w-full">
            ...
            <p className="mt-2 whitespace-nowrap text-sm font-medium sm:text-base">
              Software Engineer from Delhi NCR, India 🇮🇳
            </p>
            ...
            <section className="mt-6 flex flex-wrap items-center gap-4">
              <RouterLink href="/resume.pdf" target="_blank">
